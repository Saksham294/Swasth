        ...
        <Grid>
            <Paper elevation={10} style={paperStyle}>
                ...
                <ThemeProvider theme={theme}>
                    ...
                    <Typography ml={2} mt={2}>Don't have an account? <Link href='/register/doctor' color="#42a5f5" underline="hover">Sign Up</Link></Typography>
                    <Typography ml={2} mt={0}>Are you a patient? <Link href='/login' color="#42a5f5" underline="hover">Login here</Link></Typography>
                </ThemeProvider>
            </Paper>
